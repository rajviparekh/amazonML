...
class ProductNER(object):
    ...
    def train(self, data, labels, validation_split=0.2, batch_size=256, epochs=2):
        ...
        # Train!
        self.save()
        checkpointer = ModelCheckpoint(filepath=r'C:\Users\Rajvi\Documents\CODING\Hackathon\Amazon ML 2021\dataset52a7b21\dataset\productner-master\productner-master\models\ner.h5', verbose=1, save_best_only=False)
        print(checkpointer)
